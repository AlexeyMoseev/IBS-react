		...
		return (
			<header className={classes.header}>
				<form className={classes.searchField}>
					<button disabled className={classes.searchButton}>
						<svg
					...
					<input onChange={this.props.handleInputChange} className={classes.searchInput} placeholder='Search products' />
				</form>
				<div className={classes.accountButtons}>
					...
					<button className={classes.accountCircle}>
						<svg
							width='24'
							height='24'
							viewBox='0 0 24 24'
